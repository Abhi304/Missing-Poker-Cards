...
public static class PokerGameMapper extends Mapper<LongWritable, Text, Text, IntWritable>{
...
public static void main(String[] args) throws Exception {
    ...
    Job job = new Job(conf, "PokerGame");
    job.setJarByClass(PokerGame.class);
    job.setMapperClass(PokerGameMapper.class);
